...
export default function TypeWiseSaleRegister() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await api.get('/auth/reports/type-wise-sale-register/', {
        params: {
          branch_id: branchId,
  ...
  const handleExportPDF = () => {
    ...
    printWindow.document.write(`
      ...
      <html>
      <head>
        <title>Type-Wise Sale Register Report</title>
        <style>
  ...
  const handleExportExcel = () => {
    ...
    // Add header row
    excelData.push(['Type', 'Gross Sale', 'Discount', 'Nett Sale']);
    ...
    sortedDates.forEach(dateKey => {
      ...
      // Add daily total
      excelData.push(['Daily Total', dailyTotals.gross, dailyTotals.discount, dailyTotals.nett]);
    ...
    // Add grand total
    excelData.push(['Grand Total', grandTotals.gross, grandTotals.discount, grandTotals.nett]);
    ...
    XLSX.utils.book_append_sheet(wb, ws, 'Type Wise Sale Register');

    // Generate filename with date range
    const filename = `Type_Wise_Sale_Register_${formData.date_from}_to_${formData.date_to}.xlsx`;
    ...
    return (
      <div ref={reportRef} className="bg-white">
        ...
        <div className="report-header mb-4">
          ...
          <div className="report-title text-base font-bold mt-2">Sale Register (Type-wise)</div>
          <div className="report-subtitle text-sm text-gray-600">
            Type wise Sale Register from {formatDate(reportParams?.date_from)} to {formatDate(reportParams?.date_to)}
          </div>
        </div>
        ...
        <table className="w-full text-xs">
          <thead>
            <tr className="border-t border-b border-gray-300">
              ...
              <th className="py-2 px-1 text-right w-28">Discount</th>
              ...
              return (
                <React.Fragment key={dateKey}>
                  ...
                  <tr className="date-header">
                    <td colSpan={4} className="py-2 font-bold text-sm">
                      {formatDate(dateKey)}
                    </td>
                  </tr>
  ...
  return (
    <div className="min-h-screen bg-gray-50 p-4 md:p-6">
      ...
      <PageHeader
        ...
        title="Type-Wise Sale Register"
        subtitle="Generate type-wise sale register report"
      />
