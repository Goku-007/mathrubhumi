...
const PageHeader = ({ icon, title, subtitle, children }) => {
    return (
        <div className="relative mb-6">
            ...
            <div className="bg-white/80 backdrop-blur-sm border border-gray-200/60 rounded-xl px-6 py-4 shadow-sm">
                ...
                <div className="mt-4 h-0.5 bg-gradient-to-r from-blue-500 via-indigo-500 to-cyan-500 rounded-full opacity-60" />
            </div>
        </div>
    );
};
